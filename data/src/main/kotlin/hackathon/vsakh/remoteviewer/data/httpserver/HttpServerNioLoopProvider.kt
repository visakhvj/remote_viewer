 ...
 * client and server.
 */
internal class HttpServerNioLoopProvider internal constructor(threadCount: Int) : RxEventLoopProvider() {
    ...
    init {
        eventLoop = NioEventLoopGroup(
            threadCount,
            HttpServerThreadFactory("SSNioLoop", true, Thread.MAX_PRIORITY)
        )
